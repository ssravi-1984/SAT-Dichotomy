...
\institute{
           ...
           H.~B. Hunt III, V. Radhakrishnan, S. S. Ravi, D. J. Rosenkrantz, R. E. Stearns: 
...
({\sf 1-FPN}-specifications)  of  
 Ford  et al. and Wanke \cite{FF58,Wa93};
(2) the 1-dimensional finite periodic narrow specifications with explicit
boundary conditions 
({\sf 1-FPN(BC)}-specifications) of Gale \cite{Ga59}; 
and  
(3) the hierarchical specifications ({\sf L}-specifications)
